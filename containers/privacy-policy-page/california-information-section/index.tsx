...
export async function CaliforniaInformation() {
  return (
    <section id="do-california-residents-have-specific-privacy-rights" className="mt-8">
      ...
      <p className="mt-4 text-navy-975 text-left">You may contact us by email at{' '}
        <a href={`mailto:${BUSINESS_EMAIL}`} className="text-blue-500 hover:underline">
          {BUSINESS_EMAIL}
        </a>, by calling toll-free at {BUSINESS_PHONE}, by visiting <a href="#dpo-contact-form" className="text-blue-500 hover:underline">our Contact Form</a>, or by referring to the contact details at the bottom of this document.</p>
      ...
      <p className="mt-4 text-navy-975 text-left">To exercise these rights, you can contact us by email at{' '}
        <a href={`mailto:${BUSINESS_EMAIL}`} className="text-blue-500 hover:underline">
          {BUSINESS_EMAIL}
        </a>, by calling toll-free at { BUSINESS_PHONE }, by visiting <a href="#dpo-contact-form" className="text-blue-500 hover:underline">our Contact Form</a>, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
      ...
      <p className="mt-4 text-navy-975 text-left">If you choose to participate in the financial incentive you can withdraw from the financial incentive at any time by emailing us at{' '}
        <a href={`mailto:${BUSINESS_EMAIL}`} className="text-blue-500 hover:underline">
          {BUSINESS_EMAIL}
        </a>, by calling us toll-free at { BUSINESS_PHONE }, by visiting <a href="#dpo-contact-form" className="text-blue-500 hover:underline">our Contact Form</a>, or by referring to the contact details at the bottom of this document.</p>
