import { Heart, Wheat, Star } from "lucide-react";
...
const steps = [
  {
    ...
    title: "Early Care",
    description:
      `Calves are carefully weaned at 6 months old, beginning their journey to becoming premium Wagyu beef.`,
    icon: Heart,
  ...
  },
  {
    ...
    description:
      `The cattle are fed on specialized grower feed for one full year, building their frame and foundation. `,
    icon: Wheat,
  ...
  },
  {
    ...
    title: "Refinement",
    description:
      `The final year on finisher feed develops the signature marbling that makes Wagyu beef extraordinary.`,
    icon: Star,
    iconBgColor: "bg-red-900",
  },
];
