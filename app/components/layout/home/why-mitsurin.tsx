...
import {
  ...
  CardBody,
  CardItem,
} from "@/app/components/ui/card/3d/3d-card";
import { AnimatedProgressBar } from "@/app/components/ui/progess-bar/animated-progress-bar";
              ...
              <CardBody className="bg-zinc-800 relative group/card hover:shadow-2xl hover:shadow-emerald-500/[0.1] border-white/[0.2] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
                ...
                <div className="flex justify-between items-center mt-20">
                  ...
                  >
                    <TrackedCTA
                      href="/contact"
                      cta_id="home-why-mitsurin-order-now"
                      label="Order Now"
